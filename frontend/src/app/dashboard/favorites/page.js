    ...
    <div>
      <div style={{ marginBottom: "2rem" }}>
        <h1 style={{ fontSize: "1.875rem", fontWeight: 700, color: "var(--text-primary)", display: "flex", alignItems: "center", gap: "0.75rem" }}>
          ...
          Oportunitati Salvate
        </h1>
        <p style={{ color: "var(--text-secondary)", marginTop: "0.5rem" }}>Produsele pe care le urmaresti pentru revanzare</p>
      </div>
      ...
      <div style={{ display: "flex", gap: "0.5rem", marginBottom: "1.5rem" }}>
        <button onClick={() => setActiveTab("favorites")}
          style={{ padding: "0.625rem 1.5rem", borderRadius: "0.5rem", fontWeight: 500, fontSize: "0.875rem", cursor: "pointer", border: "none",
            backgroundColor: activeTab === "favorites" ? "#2563eb" : "var(--bg-elevated)", color: activeTab === "favorites" ? "white" : "var(--text-secondary)" }}>
        ...
        <button onClick={() => setActiveTab("blacklist")}
          style={{ padding: "0.625rem 1.5rem", borderRadius: "0.5rem", fontWeight: 500, fontSize: "0.875rem", cursor: "pointer", border: "none",
            backgroundColor: activeTab === "blacklist" ? "#dc2626" : "var(--bg-elevated)", color: activeTab === "blacklist" ? "white" : "var(--text-secondary)" }}>
          <span style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
      ...
      {items.length > 0 ? (
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.875rem" }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <h3
                    ...
                    style={{ fontSize: "0.9375rem", fontWeight: 600, color: "var(--text-primary)", marginBottom: "0.25rem", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", cursor: "help" }}
                  >
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", flexWrap: "wrap" }}>
                    ...
                    {item.notes && (
                      <span style={{ fontSize: "0.75rem", fontStyle: "italic", color: "var(--text-secondary)" }}>&quot;{item.notes}&quot;</span>
                    )}
                  </div>
                </div>
                ...
                <div style={{ width: "90px", fontSize: "0.75rem", color: "var(--text-secondary)" }}>
                ...
                <div style={{ width: "72px", display: "flex", gap: "0.25rem", justifyContent: "flex-end" }}>
                  {item.product?.source_url && (
                    <a href={item.product.source_url} target="_blank" rel="noopener noreferrer"
                      style={{ padding: "0.375rem", borderRadius: "0.5rem", color: "var(--text-secondary)", cursor: "pointer", textDecoration: "none", display: "flex" }}>
                      <ExternalLink style={{ width: "1rem", height: "1rem" }} />
                    </a>
                  )}
                  <button onClick={() => handleRemove(item.id)}
                    style={{ padding: "0.375rem", borderRadius: "0.5rem", color: "var(--text-secondary)", cursor: "pointer", border: "none", backgroundColor: "transparent", display: "flex" }}>
        ...
        <div style={{ ...cardStyle, borderRadius: "1rem", padding: "3rem", textAlign: "center" }}>
          <Package style={{ width: "4rem", height: "4rem", margin: "0 auto 1rem", color: "var(--text-secondary)" }} />
