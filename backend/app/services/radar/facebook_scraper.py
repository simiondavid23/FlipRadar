...
def _naiv_local(dt):
    ...
    TZ-3 — deleaga la `to_naive_bucuresti`, adica la `FUS_ANUNTURI`, nu la fusul MASINII.
    ...
    `to_naive_bucuresti`): pe un server in UTC, doua anunturi postate in aceeasi clipa
    ...
    """
    return to_naive_bucuresti(dt) if dt else None
