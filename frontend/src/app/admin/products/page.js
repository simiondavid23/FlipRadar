      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1.5rem", flexWrap: "wrap", gap: "0.75rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
          <div style={{ padding: "0.625rem", borderRadius: "0.75rem", backgroundColor: "#9333ea", display: "flex" }}>
            <Package style={{ width: 22, height: 22, color: "var(--text-primary)" }} />
          </div>
          <div>
                  ...
                  {filtered.map((p) => (
                    <tr key={p.id} style={{ borderTop: "1px solid var(--border-color)" }}>
                      <td style={{ padding: "0.625rem 0.5rem", color: "var(--text-primary)" }}>
                        ...
                        {p.category && (
                          <div style={{ fontSize: "0.6875rem", color: "var(--text-muted)" }}>{p.category}</div>
                        )}
                      </td>
                      <td style={{ padding: "0.625rem 0.5rem", color: "var(--text-secondary)" }}>{p.source || "-"}</td>
                      ...
                      {!userId && (
                        <td style={{ padding: "0.625rem 0.5rem" }}>
                          {p.owner ? (
                            ...
                            <span style={{ color: "var(--text-muted)", fontSize: "0.75rem" }}>(fara proprietar)</span>
                          )}
                        </td>
                      )}
